...
if((zzBOOL0004000B=(((unsigned long)StateOld>(unsigned long)0)))){
...
if((zzBOOL0004000D=(zzBOOL0004000C=(((unsigned long)StateOld>(unsigned long)0))))){


}else{goto imp4_EN000A;
}(gOutput.Cyl1CarriageLeft=(zzBOOL0004000E=0));



(gOutput.Cyl1CarriageRight=(zzBOOL0004000F=0));



(gOutput.Cyl2SwingArmDown=(zzBOOL00040010=0));



(gOutput.Cyl2SwingArmUp=(zzBOOL00040011=0));



(gOutput.Cyl3DownToEmptyBag=(zzBOOL00040012=0));



(gOutput.Cyl3EmptyBagUp=(zzBOOL00040013=0));



(gOutput.Cyl4DuckBillLeft=(zzBOOL00040014=0));



(gOutput.Cyl4DuckBillRight=(zzBOOL00040015=0));



(gOutput.Cyl5DuckBillIn=(zzBOOL00040016=0));



(gOutput.Cyl5DuckBillOut=(zzBOOL00040017=0));
...
if((zzBOOL00040019=(zzBOOL00040018=(((unsigned long)StateOld>(unsigned long)0))))){
...
imp4_EN000B:(zzBOOL00040022=gMachine.Cmd.Resume);

if((zzBOOL00040023=(((unsigned long)StateOld==(unsigned long)10)))){

(gMachineState.Sub0=1);

if((zzBOOL00040024=(((unsigned long)StateOld==(unsigned long)1)))){

(gMachineState.Sub1=1);

if((zzBOOL00040025=(((unsigned long)StateOld==(unsigned long)2)))){

(gMachineState.Sub2=1);

if((zzBOOL00040026=(((unsigned long)StateOld==(unsigned long)3)))){

(gMachineState.Sub3=1);

if((zzBOOL00040027=(((unsigned long)StateOld==(unsigned long)4)))){

(gMachineState.Sub4=1);

if((zzBOOL00040028=(((unsigned long)StateOld==(unsigned long)5)))){

(gMachineState.Sub5=1);

if((zzBOOL00040029=(((unsigned long)StateOld==(unsigned long)6)))){

(gMachineState.Sub6=1);

if((zzBOOL0004002A=(((unsigned long)StateOld==(unsigned long)7)))){

(gMachineState.Sub7=1);

if((zzBOOL0004002B=(((unsigned long)StateOld==(unsigned long)8)))){

(gMachineState.Sub8=1);

if((zzBOOL0004002C=(((unsigned long)StateOld==(unsigned long)9)))){

(gMachineState.Sub9=1);
}if(zzBOOL00040022){
(gMachine.Cmd.Pause=0);
}if((zzBOOL0004002D=zzBOOL00040022)){
